...
def next_callback(*args):
    ...
    elif features.get() == "Feedback regarding this interace":
f
        # If featuer is show college, the show College link page
        page_linking.tkraise()

        # Set text to college link text
        lbl_link["text"] = "Feedback regarding this interface " + college.get()
...
# Creating an option menu in page_home
feature_option = OptionMenu(page_home, features, "About College", "How to apply", "Syllabi and courses","Contact the college","FAQ","Feedback regarding this interface",
